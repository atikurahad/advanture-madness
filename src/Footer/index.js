...
function Footer() {
  return (
    <>
      ...
      {/* <section classNameName="h-[4rem] bg-black">
        <p classNameName="text-white text-center text-3xl">
          {" "}
          &copy; All Rights Reserved <span classNameName='text-[#feafea]'>Advanture Explore</span>{" "}
        </p>
      </section> */}
    </>
  );
